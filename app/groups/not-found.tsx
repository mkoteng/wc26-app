...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center px-4 py-24 text-center">
      ...
      <h2 className="mt-4 text-lg font-bold text-zinc-900 dark:text-white">Groups not found</h2>
      <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">We couldn&apos;t find what you were looking for.</p>
      <div className="mt-6 flex gap-3">
        <Link href="/groups" className="rounded-lg bg-pitch px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:opacity-90 dark:text-zinc-950">
          All groups
        </Link>
